...
N = len(site_data )
    ...
    #M_fin=5
    #M_step=2
    #M_save=np.array([M_start,M_step,M_fin])
...
if np.any(1 == M_save) :
    ...
    # Output path
    foutpath_int = foutpath_ini + "coalescent_" + 'M_' + str(1) + '_' + LFN_matrix
...
for count_sum in range(2,M+1,1):
        ...
        if np.any(count_sum == M_save) :
            ...
            # Output path
            foutpath_int = foutpath_ini + "coalescent_" + 'M_' + str(count_sum) + '_' + LFN_matrix
...
# Output path
foutpath = foutpath_ini + "coalescent_" + 'M_' + str(M_fin) + '_' + LFN_matrix
